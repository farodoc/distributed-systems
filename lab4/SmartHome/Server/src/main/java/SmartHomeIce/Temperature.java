                                    ...
                                    java.io.Serializable
{
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::SmartHomeIce::Temperature");
    ...
    public void ice_writeMembers(com.zeroc.Ice.OutputStream ostr)
    {
        ...
        TemperatureUnit.ice_write(ostr, this.unit);
    }

    public void ice_readMembers(com.zeroc.Ice.InputStream istr)
    {
        this.value = istr.readFloat();
        this.unit = TemperatureUnit.ice_read(istr);
    }
    ...
    /** @hidden */
    public static final long serialVersionUID = 337204243L;
}
