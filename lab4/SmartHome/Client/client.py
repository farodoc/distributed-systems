...
def display_main_menu(devices: Dict[str, SmartHomeIce.SmartDevicePrx]):
    running = True
    ...
    while running:
        ...
        if choice == "0":
            ...
            display_power_control_menu(devices)
        elif choice == "2":
            display_camera_control_menu(devices)
        elif choice == "3":
            display_co_sensor_control_menu(devices)
        elif choice == "4":
            display_ac_control_menu(devices)
        else:
            print("Invalid choice")


def display_power_control_menu(devices: Dict[str, SmartHomeIce.SmartDevicePrx]):
    while True:
        print("\n-----< POWER CONTROL >-----")
        print("Select device:")
...
def display_camera_control_menu(devices: Dict[str, SmartHomeIce.SmartDevicePrx]):
    while True:
        print("\n-----< CAMERA CONTROLS >-----")
        print("Select camera:")
        ...
        if camera_choice == "1":
            camera = devices["IndoorCamera"]
            camera_name = "Indoor Camera"
        elif camera_choice == "2":
            camera = devices["OutdoorCamera"]
        ...
        while True:
            ...
            try:
                if action == "1":
                    ...
                    if camera_choice == "1":
                        indoor_camera: SmartHomeIce.IndoorCameraPrx = devices["IndoorCamera"]
                        ...
                        outdoor_camera: SmartHomeIce.OutdoorCameraPrx = devices["OutdoorCamera"]
...
def display_co_sensor_control_menu(devices: Dict[str, SmartHomeIce.SmartDevicePrx]):
    co_sensor: SmartHomeIce.COSensorPrx = devices["COSensor"]
...
def display_ac_control_menu(devices: Dict[str, SmartHomeIce.SmartDevicePrx]):
    while True:
        ...
        ac: SmartHomeIce.AirConditionerPrx = None

        if ac_choice == "1":
            ac = devices["AirConditioner1"]
            ac_name = "Air Conditioner 1"
        elif ac_choice == "2":
            ac = devices["AirConditioner2"]
